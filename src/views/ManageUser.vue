    ...
    <el-form :model="state.user" label-width="80px" style="margin-left: 40px; margin-top: 20px">
      <el-row :gutter="50">
        <el-col :span="12">
          ...
          <el-form-item style="padding-bottom: 12px; margin-left: -50px">
            <span slot="label">
              <span style="cmargin-right: 19px">邮 箱</span>
            </span>
      ...
      <el-form-item label="">
        ...
        <el-button type="primary" style="font-weight: bold; border: none" @click="handleResetPassword" @dblclick="passwordVis=false">修改密码
        </el-button>
      </el-form-item>
    </el-form>
  </div>
